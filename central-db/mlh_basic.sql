...
--
-- Host: localhost
-- Generation Time: Jan 09, 2019 at 06:09 PM
...
('NIS3361986229222839875558', 'NFI5783345756117198991981', 'UPA147982212651', 'ALL', 'Y', 'Y', '', 'USR924357814934', '2018-11-04 15:45:06'),
('NIS5833885568348665469156', 'NFI4354888859954457818416', 'UPA147982212651', 'ALL', 'Y', 'Y', '', 'USR924357814934', '2018-10-24 17:17:09'),
('NIS9848736881174346882948', 'NFI1613311724592767271574', 'UPA147982212651', 'ALL', 'Y', 'Y', '', 'USR924357814934', '2018-11-04 15:44:34');
...
('UPA287223683747', '02-EDU', 'EDU-01-STUDTCHR', 'UPB2585569513351632525292', 'Student federation of india', 'This is a Sample Federation Union of the Country', '', '2018-11-25 11:41:11', 'USR924357814934', 'asefw', 'defwr', 'fefwr', '', '', '', '', '', '', '');
...
('UPB2585569513351632525292', 'UPA287223683747', 'Nampong', 'Arunachal East', 'Arunachal Pradesh', 'India', '2018-11-25 11:41:12', 'USR924357814934', 'Y');
...
('UPM765427611383', 'UPA287223683747', 'UPB2585569513351632525292', 'USR924357814934', 'UPRO474435488885995445781', 'UPRO474435488885995445781', 'N', '2018-11-25 11:41:27', 'N', '2018-11-25 11:41:27', 'USR924357814934', 'OFFLINE');
...
INSERT INTO `unionprof_mem_perm1` (`permission1_Id`, `user_Id`, `union_Id`, `createABranch`, `createABranchNotify`, `updateBranchInfo`, `updateBranchInfoNotify`, `deleteBranch`, `deleteBranchNotify`, `shiftMainBranch`, `shiftMainBranchNotify`, `createNewsFeedUnionLevel`, `createNewsFeedUnionLevelNotify`, `approveNewsFeedUnionLevel`, `approveNewsFeedUnionLevelNotify`, `createMovementUnionLevel`, `createMovementUnionLevelNotify`, `approveMovementUnionLevel`, `approveMovementUnionLevelNotify`, `createMovementSubDomainLevel`, `createMovementSubDomainLevelNotify`, `approveMovementSubDomainLevel`, `approveMovementSubDomainLevelNotify`, `createMovementDomainLevel`, `createMovementDomainLevelNotify`, `approveMovementDomainLevel`, `approveMovementDomainLevelNotify`, `updatePerm1`, `updatePerm1Notify`, `updatedPermOn`) VALUES
('UP1P624586657164827621523', 'USR113561617186', 'UPA287223683747', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '2018-11-25 11:41:25'),
('UP1P814815569334381139946', 'USR924357814934', 'UPA287223683747', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', 'Y', 'N', '2018-11-25 11:41:30');
...
('UPMR47891685367', 'UPA287223683747', 'UPB2585569513351632525292', 'UPRO561453948162424568552', 'USR924357814934', 'USR113561617186', '', '2018-11-25 11:41:23', 'N', 'N');
...
('UPRO474435488885995445781', 'UPA287223683747', 'UPB2585569513351632525292', 'President of student federation of india', '2018-11-25 11:41:15'),
('UPRO841658338855683486654', 'UPA287223683747', 'UPB2585569513351632525292', 'Members', '2018-11-25 11:41:19');
...
INSERT INTO `user_frnds_req` (`req_Id`, `from_userId`, `to_userId`, `usr_frm_call_to`, `usr_to_call_from`, `req_on`, `req_tz`, `reqMessage`, `notify`, `watched`) VALUES
...
ALTER TABLE `unionprof_mem_perm1`
  ADD CONSTRAINT `unionprof_mem_perm1_ibfk_1` FOREIGN KEY (`user_Id`) REFERENCES `user_account` (`user_Id`),
  ADD CONSTRAINT `unionprof_mem_perm1_ibfk_2` FOREIGN KEY (`union_Id`) REFERENCES `unionprof_account` (`union_Id`);
