...
function searchCommunitycontentData(div_view, appendContent,limit_start,limit_end){
 ...
 for(var index=0;index<response.length;index++){
   ...
   content+=ui_communityDisplay(param_unionId, param_domainName,param_subdomainName,
...
function ui_communityDisplay(param_unionId, param_domainName,param_subdomainName,
    param_profilepic,param_unionName,param_createdOn,param_minlocation,param_location,param_state,param_country){
 var content='<div class="list-group" style="margin-bottom:10px;">';
    ...
    content+='<b>'+param_domainName+' / '+param_subdomainName+'</b></span>';
    content+='</div>';
	...
	content+='<div align="center" style="line-height:15px;color:#87898a;font-size:12px;">joined on ';
	content+=get_stdDateTimeFormat01(param_createdOn)+' IST</div>';
	content+='</div>';
