 ...
 * ELSE, Empty Form
 */
var userEnteredPhoneNumberWithCountryCode = JSON.parse(AUTH_USER_CURPHONENUMBER);
var userEnteredCountryCode = userEnteredPhoneNumberWithCountryCode[0].mcountrycode;
var userEnteredPhoneNumber = userEnteredPhoneNumberWithCountryCode[0].mobile;
console.log(userEnteredCountryCode+":::"+userEnteredPhoneNumber);
js_ajax("GET",PROJECT_URL+'backend/php/dac/controller.module.app.user.authentication.php',
 { action:'USERINFO_BY_PHONENUMBER',projectURL:PROJECT_URL, countrycode:userEnteredCountryCode,
   phoneNumber:userEnteredPhoneNumber }, function(response){
...
if(response.length>0){
  ...
  var contactData = JSON.stringify(response[0].contactData);
  ...
  var sessionJSON='{"session_set":[';
	  ...
	  sessionJSON+='{"key":"AUTH_USER_PHONENUMBERS","value":'+contactData+'}';
	  sessionJSON+='],';
	  ...
	  sessionJSON+='"AUTH_USER_COUNTRYCODE","AUTH_USER_PHONENUMBERS" ]}';
