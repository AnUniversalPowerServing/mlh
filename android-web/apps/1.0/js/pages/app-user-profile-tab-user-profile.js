...
var content='<div class="container-fluid mbot15p">';
    ...
    content+='<div class="col-xs-12"><h5><b>About '+surName+' '+name+'</b></h5><hr/></div>';
    content+='</div>';
	content+='<div class="row">';
	content+='<div class="col-xs-12" style="color:#ccc;">';
...
var content='<div class="container-fluid mbot15p">';
	...
	content+='</button>';
	content+='<a href="'+PROJECT_URL+'app/edit/userprofile">';
