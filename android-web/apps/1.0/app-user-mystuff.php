 ...
 <div id="wrapper" class="toggled">
  ...
  <div id="page-content-wrapper">
	...
	<div class="container-fluid mtop15p">
	  <div class="row">
	    <div class="col-xs-6">
		 <a href="<?php echo $_SESSION["PROJECT_URL"]?>app/user/<?php echo $_SESSION["AUTH_USER_ID"]?>" class="a-custom">
		...
		<div class="col-xs-6">
		 <a href="<?php echo $_SESSION["PROJECT_URL"]?>app/myfriends" class="a-custom">
		  <div class="list-group">
