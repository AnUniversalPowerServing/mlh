...
// function mainTab_userMyFriends(){ hzTabSelection("usrFriendsHzTab"); }
</script>
</head>
<body>
...
function sel_topMenuTab(id){
 var arry_Id=["menuTab_userprofile","menuTab_userlocation"];
 var arry_content=["menuContent_userprofile","menuContent_userlocation"];
 ...
 if(id==='menuTab_userlocation'){ setup_maplayout(); }
}
</script>	   
			   ...
			   <div class="list-group-item">
			      <div class="container-fluid pad0">
					<div class="row">
					  ...
					  <div align="center" class="col-xs-6">
					    <span id="menuTab_userlocation" class="pad10 curpoint" onclick="javascript:sel_topMenuTab(this.id);">
						  <b>User Location</b>
						</span>
					  </div><!-- col-xs-6 -->
					</div><!-- row -->
	   ...
	   <div id="menuContent_userlocation" class="container-fluid hide-block">
	     <?php include_once 'templates/pages/app-user-profile/user-location.php'; ?>
	   </div>
