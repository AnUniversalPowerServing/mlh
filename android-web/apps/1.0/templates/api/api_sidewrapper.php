...
function logout(){
 js_ajax("POST",PROJECT_URL+'backend/php/api/app.session.php',{action:'DestroySession'},function(response){
  ...
  /* Also reset data in Android Sessions in Sharedpreferences */
  if(AndroidSession!==undefined){
    AndroidSession.deleteAndroidSession('AUTH_USER_ID');
	AndroidSession.deleteAndroidSession('AUTH_USER_USERNAME');
	AndroidSession.deleteAndroidSession('AUTH_USER_SURNAME');
	AndroidSession.deleteAndroidSession('AUTH_USER_FULLNAME');
	AndroidSession.deleteAndroidSession('AUTH_USER_CURPHONENUMBER');
	AndroidSession.deleteAndroidSession('AUTH_USER_PHONENUMBERS');
	AndroidSession.deleteAndroidSession('AUTH_USER_GENDER');
	AndroidSession.deleteAndroidSession('AUTH_USER_DOB');
	AndroidSession.deleteAndroidSession('AUTH_USER_COUNTRY');
	AndroidSession.deleteAndroidSession('AUTH_USER_STATE');
	AndroidSession.deleteAndroidSession('AUTH_USER_LOCATION');
	AndroidSession.deleteAndroidSession('AUTH_USER_LOCALITY');
	AndroidSession.deleteAndroidSession('AUTH_USER_PROFILEPIC');
	AndroidSession.deleteAndroidSession('AUTH_USER_TIMEZONE');
	AndroidSession.deleteAndroidSession('AUTH_USER_ISADMIN');
	AndroidSession.deleteAndroidSession('AUTHENTICATION_STATUS','INCOMPLETED');
  }
 });
}
</script>
...
<ul class="sidebar-nav">
 ...
 <li>
	<a id="dn_english_adminDashboard" href="<?php echo $_SESSION["PROJECT_URL"]?>app/admin-dashboard" 
