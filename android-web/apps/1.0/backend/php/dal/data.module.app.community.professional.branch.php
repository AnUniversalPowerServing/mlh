...
class ProfessionalCommunityBranch {
 ...
 function query_add_createPermissions1($permission1_Id, $user_Id, $union_Id, $createABranch, $createABranchNotify,
  $updateBranchInfo, $updateBranchInfoNotify, $deleteBranch, $deleteBranchNotify, $shiftMainBranch, $shiftMainBranchNotify,
  ...
  $approveMovementDomainLevel, $approveMovementDomainLevelNotify, $updatePerm1, $updatePerm1Notify){
  $sql="INSERT INTO unionprof_mem_perm1(permission1_Id, user_Id, union_Id, createABranch, createABranchNotify, ";
  $sql.="updateBranchInfo, updateBranchInfoNotify, deleteBranch, deleteBranchNotify, shiftMainBranch, shiftMainBranchNotify, ";
  $sql.="createNewsFeedUnionLevel, createNewsFeedUnionLevelNotify, approveNewsFeedUnionLevel, approveNewsFeedUnionLevelNotify, "; 
  $sql.="createMovementUnionLevel, createMovementUnionLevelNotify, approveMovementUnionLevel, approveMovementUnionLevelNotify, ";
  $sql.="createMovementSubDomainLevel, createMovementSubDomainLevelNotify, approveMovementSubDomainLevel, ";
  $sql.="approveMovementSubDomainLevelNotify, createMovementDomainLevel, createMovementDomainLevelNotify, ";
  $sql.="approveMovementDomainLevel, approveMovementDomainLevelNotify, updatePerm1, updatePerm1Notify, updatedPermOn) ";
  $sql.=" VALUES('".$permission1_Id."', '".$user_Id."', '".$union_Id."', '".$createABranch."', '".$createABranchNotify."', ";
  $sql.="'".$updateBranchInfo."', '".$updateBranchInfoNotify."', '".$deleteBranch."', '".$deleteBranchNotify;
  $sql.="', '".$shiftMainBranch."', '".$shiftMainBranchNotify."', '".$createNewsFeedUnionLevel."', '";
  $sql.=$createNewsFeedUnionLevelNotify."', '".$approveNewsFeedUnionLevel."', '".$approveNewsFeedUnionLevelNotify;
  ...
  $sql.="', '".$updatePerm1."','".$updatePerm1Notify."', '".date('Y-m-d H:i:s')."'); ";
  return $sql;
 }
 ...
 function query_add_createPermissions2($permission2_Id, $role_Id, $createRole,
  ...
  $sql.=" approveMovementBranchLevel, approveMovementBranchLevelNotify, updatePerm2, updatePerm2Notify, ";
  $sql.=" updatedPermOn) ";
  ...
  $sql.="','".$updatePerm2."','".$updatePerm2Notify."','".date('Y-m-d H:i:s')."');";
  return $sql;
 }
