...
function query_getSearchedCommunityList($searchQuery,$limit_start,$limit_end){
 $sql="SELECT DISTINCT(unionprof_account.union_Id), unionprof_account.domain_Id, unionprof_account.subdomain_Id, ";
 $sql.="(SELECT domainName FROM subs_dom_info WHERE subs_dom_info.domain_Id=unionprof_account.domain_Id) As domainName, ";
 $sql.="(SELECT subdomainName FROM subs_subdom_info WHERE subs_subdom_info.subdomain_Id=unionprof_account.subdomain_Id) ";
 $sql.=" As subdomainName, unionprof_account.unionName, unionprof_account.profile_pic, ";
 $sql.="unionprof_branch.minlocation, unionprof_branch.location, unionprof_branch.state, unionprof_branch.country, ";
 $sql.="unionprof_account.created_On FROM unionprof_account, unionprof_branch ";
 $sql.="WHERE ";
 $sql.="unionprof_account.main_branch_Id = unionprof_branch.branch_Id AND ";
 $sql.="unionprof_account.union_Id = unionprof_account.union_Id AND (unionprof_account.unionName LIKE '%".$searchQuery."%' ";
 $sql.="OR unionprof_branch.minlocation LIKE '%".$searchQuery."%' ";
